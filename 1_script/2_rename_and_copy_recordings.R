...
orig_dir = 
  "//hemmera.com/Shared/ProjectScratch/106242-01 Bird and Bat Data/Rayrock Bird Data - RAW/
    Check 1/SB02/Data" # where files are kept and not modified

cop_dir = "C:/Users/jeremiah.kennedy/Documents/Rayrock/SB02/Data" # where files are copied to and modified there

# create directory 
dir.create(cop_dir,recursive = T)

# Copy files
file.copy(list.files(orig_dir,pattern = "*.wav"),cop_dir)
